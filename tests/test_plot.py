...
#aeffs = factory.get("IceCube-TracksOnly")
aeffs = factory.get("Fictive-Optical")

from matplotlib.colors import LogNorm

track_aeff = aeffs["unshadowed_tracks"][1]
print(np.diff(track_aeff.get_bin_edges("true_zenith_band")))
